...
<body>
  ...
  <div class="intro" style="text-align: center;">
    <h1 class="logo-header">
      <svg class="logo" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-asterisk" viewBox="0 0 16 16">
  ...
  <div class="container-fluid mx-0 my-3" style="background-color: #faf3e0; color: #303926;">
    <div class="row">
      <div class="col-lg">
        ...
        <?php
        if (!isset($_SESSION["utentiID"])) {
          echo "<a class='btn btn-xxl btn-primary mb-4' role='button' style='font-size: 30px; border-radius: 25px;'
  ...
  <div class="container-fluid my-3" style="background-color: #faf3e0; color: #303926">
    <div class="row">
      ...
      <h1 class="text-center"> Rendendolo Meravigliosamente Semplice</h1>
    </div>
    <div class="row roundedDiv">
      <div class="col-sm">
        <div class="card" style="width: 20rem; height:520px">
  ...
  <div class="container-fluid mx-0" style="background-color: #faf3e0; color: #303926;">
    <div class="row roundedDiv">
      <div class="col-sm" style="text-align: center;">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-asterisk" viewBox="0 0 16 16">
          <path d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z" />
      ...
      <div class="col-sm">
        <img src="pictures/kaufmann-mercantile-a7Woj8W6J0s-unsplash.jpg" class="img-responsive Img" alt="Responsive image" style="margin-bottom: 20px; max-width: 1800px; max-height: 800px;">
      </div>
    </div>
  </div>
  <!--curiosità-->
  <div class="container-fluid my-3" style="background-color: #faf3e0; color: #303926">
    <div class="row">
      ...
      <h1 class="text-center"> Alcune Curiosità che Forse non Conoscevi</h1>
    </div>
    <div class="row">
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
          <button style="background-color: #303926;" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
          <button style="background-color: #303926;" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="1" aria-label="Slide 2"></button>
          <button style="background-color: #303926;" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2" aria-label="Slide 3"></button>
          <button style="background-color: #303926;" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="3" aria-label="Slide 4"></button>
          <button style="background-color: #303926;" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="4" aria-label="Slide 5"></button>
        </div>
        <div class="carousel-inner ">
          <div class="carousel-item active">
            <img src="pictures/pexels-pixabay-66896.jpg" class="d-block w-100" style="object-fit: cover;height:500px;border-bottom: 3px solid #303926;">
          ...
          <div class="carousel-item">
            <img src="pictures/pexels-ella-wei-6601422.jpg" class="d-block w-100" style="object-fit: cover;height:500px;border-bottom: 3px solid #303926; ">
            <div class="card-body" style="background-color: #C9C0B9
                    ">
          ...
          <div class="carousel-item">
            <img src="pictures/pexels-cottonbro-5103048.jpg" class="d-block w-100" style="object-fit: cover;height:500px;border-bottom: 3px solid #303926;">
            <div class="card-body" style="background-color: #C9C0B9">
          ...
          <div class="carousel-item">
            <img src="pictures/pexels-karolina-grabowska-4041392.jpg" class="d-block w-100" style="object-fit: cover;height:500px;border-bottom: 3px solid #303926;">
            <div class="card-body" style="background-color: #C9C0B9;
                    ">
          ...
          <div class="carousel-item">
            <img src="pictures/pexels-lexie-blessing-4173853.jpg" class="d-block w-100" style="object-fit: cover;height:500px;border-bottom: 3px solid #303926;">
            <div class="card-body" style="background-color: #C9C0B9">
